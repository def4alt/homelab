...
- [x] (2026-04-25) Add a custom Hermes container image definition and GitHub Actions workflow that publishes OCR/PDF tooling (`tesseract`, `pdftotext`, `pdftoppm`, `mutool`, `gs`, `ocrmypdf`) to GHCR, then point the Deployment at that image.
